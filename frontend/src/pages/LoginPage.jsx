      ...
      >
        ...
        >
          <h2 className="text-4xl font-bold leading-tight text-slate-100 mb-4">
            Organiza tu trabajo.
            <br />
            <span style={{ color: "#F59E0B" }}>Domina tu tiempo.</span>
          </h2>
          <p className="text-slate-400 text-lg leading-relaxed max-w-sm">
            TaskFlow te ayuda a gestionar proyectos con claridad, velocidad y
            estilo.
          </p>

          {/* Feature pills */}
          <div className="flex flex-wrap gap-2 mt-8">
            {["Kanban Board", "Estadísticas", "Tiempo real"].map((feat) => (
              <span
                key={feat}
